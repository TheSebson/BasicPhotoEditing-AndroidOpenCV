...
public class OnlyBlue implements EditType {

    private Scalar lower = new Scalar(17, 15, 100);
    private Scalar upper = new Scalar(50, 56, 200);
    ...
    public Bitmap processImage(Bitmap bitmap) {
        ...
        try{
            ...
            Imgproc.cvtColor(mRgba, imgHsv, Imgproc.COLOR_mRGBA2RGBA);
